...
void Example03()
{
  ...
  TFile *file = new TFile("/eos/user/s/shilpi/SWAN_projects/ECAL_noise_EM_discrimination/data/outputPSWithPU.root");
  ...
  ///Draw another one 
  TFile *file1 = new TFile("/eos/user/s/shilpi/SWAN_projects/ECAL_noise_EM_discrimination/data/outputPSWithoutPU.root");
