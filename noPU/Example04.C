...
void Example04()
{
  ...
  TString filenameOutput = Form("/eos/user/s/shilpi/SWAN_projects/ECAL_noise_EM_discrimination/data/noise_0p15/0p15GeV/outputPSWithoutPU_withNoise.root"); 
  //TString filenameOutput = "/eos/user/s/shilpi/SWAN_projects/ECAL_noise_EM_discrimination/data/outputPSWithoutPU_withNoise.root"; 
  ...
  int nSmpl = NSAMPLES;
  int nFreq = NFREQ;
  double samples[NSAMPLES], samplesNoise[NSAMPLES];
